 ...
 */
export function createSeeTool(driver) {
    return defineTool({
        name: 'computer-see',
        description: 'Take a screenshot and describe it using a vision model. '
...
// ---------------------------------------------------------------------------
export function createClickTool(driver) {
    return defineTool({
        name: 'computer-click',
        description: 'Simulate a left mouse click at the given screen coordinates (physical pixels, DPI-aware). '
...
export function createRightclickTool(driver) {
    return defineTool({
        name: 'computer-rightclick',
        description: 'Simulate a right mouse click at the given screen coordinates (physical pixels, DPI-aware).',
        parameters: {
...
// computer-drag
// ---------------------------------------------------------------------------
export function createDragTool(driver) {
    return defineTool({
        name: 'computer-drag',
        description: 'Simulate a mouse drag from one screen position to another (physical pixels).',
        parameters: {
...
// ---------------------------------------------------------------------------
export function createTypeTool(driver) {
    return defineTool({
        name: 'computer-type',
        description: 'Type text into the currently focused field via clipboard paste. '
...
export function createKeyTool(driver) {
    return defineTool({
        name: 'computer-key',
        description: 'Send a keyboard shortcut or key combination. '
        ...
        output: {
            ...
            render: (_args, value) => [{ type: 'text', text: `Sent: ${String(value.sent)}` }],
        },
        async execute(args) {
...
// computer-scroll
// ---------------------------------------------------------------------------
export function createScrollTool(driver) {
    return defineTool({
        name: 'computer-scroll',
        description: 'Scroll the mouse wheel at screen coordinates. Positive delta scrolls up, negative scrolls down.',
        parameters: {
            x: { type: 'number', required: true, description: 'Screen X coordinate.' },
            y: { type: 'number', required: true, description: 'Screen Y coordinate.' },
            delta: {
...
// computer-knowledge
// ---------------------------------------------------------------------------
export function createKnowledgeTool(driver) {
    return defineTool({
        name: 'computer-knowledge',
        description: 'Query the self-evolving application knowledge base. '
